...
export const tareasOperativas: TareaOperativa[] = [
  ...
  { id: 'TSK-04', categoria: 'CapEx Prioritario', titulo: 'Levantamiento técnico para renivelación de pisos', naveId: 'NAVE-11', responsable: 'Ing. Tomás Guerrero — Facility Manager Regional Norte', columna: 'Por Iniciar', costoEstimado: 890_000, avancePct: null, cotizacionesRecibidas: null, slaRestanteHoras: null },
  ...
  { id: 'TSK-07', categoria: 'Correctivo Inmediato', titulo: 'Reparación de sello hidráulico — niveladora andén 6', naveId: 'NAVE-11', responsable: 'Ing. Tomás Guerrero — Facility Manager Regional Norte', columna: 'En Cotización', costoEstimado: 31_000, avancePct: null, cotizacionesRecibidas: '3/3 recibidas · Listo', slaRestanteHoras: 26 },
